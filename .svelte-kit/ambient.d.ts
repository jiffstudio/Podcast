...
declare module '$env/static/private' {
	...
	export const http_proxy_host: string;
	...
	export const CLAUDE_EMAIL: string;
	...
	export const CLAUDE_PASSWORD: string;
	...
	export const http_proxy_port: string;
	export const npm_config_npm_version: string;
	export const XPC_FLAGS: string;
	export const FORCE_COLOR: string;
	export const CONDA_LOG_LEVEL: string;
	...
	export const CODEX_API_KEY: string;
	export const COMPOSER_NO_INTERACTION: string;
	export const VSCODE_IPC_HOOK: string;
	export const VSCODE_CODE_CACHE_PATH: string;
	export const GUILE_SYSTEM_EXTENSIONS_PATH: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		GUILE_SYSTEM_EXTENSIONS_PATH: string;
